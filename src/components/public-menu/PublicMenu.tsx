    ...
    <div ref={rootRef} className="relative z-40">
      ...
      {open && (
        ...
        >
          ...
          <div className={isLoaded && isSignedIn ? "border-t border-zinc-200 pt-1.5 dark:border-white/10" : ""}>
            {!isLoaded ? (
              <div role="menuitem" aria-disabled="true" className={`${ITEM_CLASS_NAME} cursor-wait text-zinc-400`}>
