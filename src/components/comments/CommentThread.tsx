  ...
  return (
    <section className="mt-12 flex flex-col gap-4">
      ...
      {user ? (
        ...
        <p className="text-sm text-neutral-500 dark:text-neutral-400">Faça login para comentar.</p>
      )}

      {(comments.length > 0 || hasMore) && (
        <div className="flex flex-col gap-4 border-t border-neutral-950/10 pt-5 dark:border-white/10">
          {hasMore && (
            <button
              type="button"
