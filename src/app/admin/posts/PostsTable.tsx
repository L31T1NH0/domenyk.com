          ...
          <div className="flex flex-wrap items-center gap-2">
            <label className="relative">
              ...
              <input
                ...
                className="h-9 w-56 rounded-md border border-neutral-200 bg-transparent pl-8 pr-3 text-sm outline-none transition focus:border-neutral-400 dark:border-white/10 dark:focus:border-white/30"
              />
            </label>
            ...
            <select
              ...
              className="h-9 rounded-md border border-neutral-200 bg-white px-2 text-sm outline-none dark:border-white/10 dark:bg-[#080808]"
            >
            ...
            <button
              ...
              className="inline-flex h-9 items-center gap-1.5 rounded-md border border-neutral-200 px-3 text-sm transition hover:bg-neutral-50 disabled:opacity-40 dark:border-white/10 dark:hover:bg-white/5"
            >
            ...
            <div className="relative">
              ...
              {showConfig && (
                <div className="absolute right-0 top-11 z-20 w-52 rounded-lg border border-neutral-200 bg-white p-2 shadow-lg dark:border-white/10 dark:bg-neutral-950">
